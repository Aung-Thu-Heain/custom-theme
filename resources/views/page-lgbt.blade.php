  ...
  <div class="max-w-6xl grid md:grid-cols-3 grid-cols-1  mx-auto px-4 gap-1">
    ...
    <div class="col-span-1 row-span-1">
     <div class="grid grid-cols-2 gap-1">
      <img src="{{Vite::asset('resources/images/lgbt/grid-3.png')}}" class="object-cover h-full w-full" alt="">
      <img src="{{Vite::asset('resources/images/lgbt/grid-3-1.png')}}" class="object-cover h-full w-full" alt="">
     </div>
    </div>
    <div class=" min-h-[249px]  col-span-2 ">
    ...
    <div class=" col-span-1 row-span-1">
      <div class="grid grid-cols-2 gap-1">
        <img src="{{Vite::asset('resources/images/lgbt/grid-8.png')}}" class="object-cover h-full w-full" alt="">
        <img src="{{Vite::asset('resources/images/lgbt/grid-8-1.png')}}" class="object-cover h-full w-full" alt="">
       </div>
    </div>
