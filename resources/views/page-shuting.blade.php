...
$goodImages = [
  'suiting' => [
    ['src' => Vite::asset('resources/images/fabrics/good1.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good2.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good3.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good4.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good5.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good6.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good7.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good8.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good9.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good10.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good11.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good12.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good13.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good14.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good15.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good16.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good17.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good18.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good19.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good20.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good21.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good22.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good23.jpg'),'caption' => ''],
    ['src' => Vite::asset('resources/images/fabrics/good24.jpg'),'caption' => ''],
  ],
  'shirting' => [
...
<section class="bg-[#010024] text-white font-sans">
      ...
      <ul class="space-y-4 leading-10 " id="default-tab" data-tabs-toggle="#default-tab-content" data-tabs-active-classes="text-yellow-200" role="tablist">
        @foreach($goodImages as $key => $imageGroup)
          <div class="flex items-center gap-2 justify-between">
            ...
            <span class="w-[25px] h-[25px] bg-[#C5B359] rounded-full text-black text-center leading-6">{{count($goodImages[$key])}}</span>
          </div>
        @endforeach
      ...
      <hr class="border-gray-500 my-3">
        @foreach($premiumImages as $key => $imageGroup)
          <div class="flex items-center gap-2 justify-between">
            ...
            <span class="w-[25px] h-[25px] bg-[#C5B359] rounded-full text-black text-center leading-6">{{count($premiumImages[$key])}}</span>
          </div>
        @endforeach
  ...
  <div class="flex-1 px-6 pt-10 pb-5 md:px-[50px] md:pt-[100px] md:pb-[20px]" id="default-tab-content">
       @foreach($goodImages as $key => $imageGroup)
          <div class="hidden" id="{{$key}}" role="tabpanel" aria-labelledby="wool-tab">
              <div class="grid grid-cols-2 md:grid-cols-4 gap-4 ">
                @foreach ($goodImages[$key] as $image)
                    <div class="relative holographic-card group " data-aos="zoom-in">
       ...
       @foreach($premiumImages as $key => $imageGroup)
          <div class="hidden" id="{{$key}}" role="tabpanel" aria-labelledby="wool-tab">
              <div class="grid grid-cols-2 md:grid-cols-4 gap-4 ">
                @foreach ($premiumImages[$key] as $image)
                    <div class="relative holographic-card group " data-aos="zoom-in">
                      <img class="h-[200px]  w-full object-cover rounded-lg cursor-pointer" onclick="openModal({{ $loop->index }}, '{{ $key }}')" src="{{$image['src']}}" alt="">
                      <div class="absolute bottom-0 left-0 right-0 text-white p-1 text-center caption-text opacity-0 group-hover:opacity-100 transition-opacity duration-1000"
                          style="background-color: rgba(0, 0, 0, 0.6);">
