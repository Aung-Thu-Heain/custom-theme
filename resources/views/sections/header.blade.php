      ...
      <nav class="mx-auto flex max-w-7xl items-center justify-between p-3 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            ...
            <img class="h-73px w-auto" src="{{Vite::asset('resources/images/header/logo.svg')}}" alt="">
          </a>
        </div>
        ...
        <div class="hidden lg:flex lg:gap-x-12">
          <a href="#" class="text-sm/6 font-semibold ">Be Spoke</a>
          <a href="#" class="text-sm/6 font-semibold ">About Us</a>
          <div class="relative">
            <button type="button" class="flex items-center gap-x-1 text-sm/6 font-semibold " aria-expanded="false">
              Explore
          ...
          <a href="#" class="text-sm/6 font-semibold ">Contact Us</a>
        </div>
